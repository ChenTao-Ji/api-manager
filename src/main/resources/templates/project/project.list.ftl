         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8"><input type="text" class="form-control" name="description" placeholder="请输入“项目描述”" maxlength="200" ></div>
                    </div>
                    <div class="form-group">
...
<script>
    // 业务线权限
    var superUser = <#if API_LOGIN_IDENTITY.type == 1 >true<#else>false</#if>;
    var permissionBiz = '${API_LOGIN_IDENTITY.permissionBiz!""}';
