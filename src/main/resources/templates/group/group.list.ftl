         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="orders" placeholder="请输入“分组排序”" maxlength="5" ></div>
                    </div>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">分组排序<font color="red">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="order" placeholder="请输入“分组排序”" maxlength="5" value="<#if groupInfo?exists>${groupInfo.orders}</#if>" ></div>
                    </div>
