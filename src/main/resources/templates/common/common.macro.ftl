...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b></b>ChenTao-Ji</span>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            欢迎 ${Request["API_LOGIN_IDENTITY"].username}
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>ChenTao-Ji</b>
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2019-${.now?string('yyyy')} &nbsp;
                <a href="https://github.com/ChenTao-Ji" target="_blank" >ChenTao-Ji</a>&nbsp;
